...
//    TString saving_path_new = saving_path+run_number;
    TString saving_path = "/afs/cern.ch/user/n/nrawal/work/CSC_GIF_new/CMSSW_12_0_0_pre4/src/analyze_folder/MuonExercise0/analyze_output/analyze_all/plots/run_7783_all/";
  public: 
    TFile *my_file;
...
TString input_file = "/afs/cern.ch/user/n/nrawal/work/CSC_GIF_new/CMSSW_12_0_0_pre4/src/analyze_folder/MuonExercise0/test/outputFiles/output_7783_all.root";
...
double trimmed_mean_ME21_layers_with_cuts[6], trimmed_mean_ME21[6], trimmed_mean_ME11[6];
