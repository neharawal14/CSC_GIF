...
class plotting{
  ...
  public:
    ...
    plotting(TString filename, TString dir_name, TString run, TString output_folder);
...
//    TString saving_path_new = saving_path+run_number;
    TString saving_path_prefix = "/afs/cern.ch/user/n/nrawal/work/CSC_GIF_new/CMSSW_12_0_0_pre4/src/analyze_folder/MuonExercise0/analyze_output/analyze_all_new/plots/";
    TString  saving_path;
    TString saving_path_text_files_here = "/afs/cern.ch/user/n/nrawal/work/CSC_GIF_new/CMSSW_12_0_0_pre4/src/analyze_folder/MuonExercise0/analyze_output/analyze_all_new/text_files_all/";
  public: 
    TFile *my_file;
...
TH1F * h_charge_CFEB_1_ME11; TH1F * h_charge_CFEB_2_ME11; TH1F * h_charge_CFEB_3_ME11; TH1F * h_center_strip_ME21; TH1F * h_center_strip_ME11; double layers[6] = {1,2,3,4,5,6}; double chi_square, mpv_value, n_degree, chi_square_degree; ofstream myfile_ME11, myfile_ME21, myfile_ME21_cuts, myfile_ME11_cuts; ofstream  myfile_ME21_position_cuts;
...
plotting::plotting(TString filename, TString dir_name, TString run, TString output_folder){
   
    saving_path = saving_path_prefix + output_folder +"/";
    my_file = TFile::Open(filename);
    directory_name = (TDirectoryFile*)my_file->Get(dir_name);
    myfile_ME11.open(saving_path_text_files_here+run+"_ME11_MPV.txt",std::ios_base::app);
    myfile_ME21.open(saving_path_text_files_here+run+"_ME21_MPV.txt",std::ios_base::app);
    myfile_ME11_cuts.open(saving_path_text_files_here+run+"_ME11_MPV_cuts.txt",std::ios_base::app);
    myfile_ME21_cuts.open(saving_path_text_files_here+run+"_ME21_MPV_cuts.txt",std::ios_base::app);
    myfile_ME21_position_cuts.open(saving_path_text_files_here+run+"_ME21_MPV_position_cuts.txt",std::ios_base::app);
  
    myfile_ME11<<"Layers"<<"\t\t"<<"MPV"<<"\t\t"<<"chi_square"<<"\t\t"<<"ndf"<<"\t\t"<<"chi_square_per_ndf"<<std::endl;
    myfile_ME21<<"Layers"<<"\t\t"<<"MPV"<<"\t\t"<<"chi_square"<<"\t\t"<<"ndf"<<"\t\t"<<"chi_square_per_ndf"<<std::endl;
    myfile_ME11_cuts<<"Layers"<<"\t\t"<<"MPV"<<"\t\t"<<"chi_square"<<"\t\t"<<"ndf"<<"\t\t"<<"chi_square_per_ndf"<<std::endl;
    myfile_ME21_cuts<<"Layers"<<"\t\t"<<"MPV"<<"\t\t"<<"chi_square"<<"\t\t"<<"ndf"<<"\t\t"<<"chi_square_per_ndf"<<std::endl;
    myfile_ME21_position_cuts<<"Layers"<<"\t\t"<<"MPV"<<"\t\t"<<"chi_square"<<"\t\t"<<"ndf"<<"\t\t"<<"chi_square_per_ndf"<<std::endl;
...
void analyze_files(TString input_root_file, TString output_folder, TString run_number){
gROOT->SetBatch(kTRUE);
TString input_file_path = "/afs/cern.ch/user/n/nrawal/work/CSC_GIF_new/CMSSW_12_0_0_pre4/src/analyze_folder/MuonExercise0/test/outputFiles/";
TString input_file = input_file_path + input_root_file;
TString direc_name = "demo";

TString saving_path_text_files = "/afs/cern.ch/user/n/nrawal/work/CSC_GIF_new/CMSSW_12_0_0_pre4/src/analyze_folder/MuonExercise0/analyze_output/analyze_all_new/text_files_all/";
plotting obj(input_file,direc_name, run_number, output_folder);
...
mpv_ME21_position_cuts= obj.fitting_landau(obj.h_charge_ME21_position_cuts, "ME21 layer after position selection", "ME21_position_cuts.pdf","ME21_position_cuts","layers");
...
fit_txt_ME21_with_position_cuts.open(saving_path_text_files+run_number+"_ME21_position_cuts_trimmed.txt",std::ios_base::app);
fit_txt_mpv.open(saving_path_text_files+run_number+"_ME21_with_cuts_trimmed.txt",std::ios_base::app);
fit_txt_ME11_with_cuts.open(saving_path_text_files+run_number+"_ME11_with_cuts_trimmed.txt",std::ios_base::app);
