...
obj.fitting_landau(obj.h_21[2], "ME21 2nd layer", "ME21_second_layer.pdf",1000,50000,minimum_ME21_second_layer,maximum_ME21_second_layer);
obj.fitting_landau(obj.h_21[3], "ME21 3rd layer", "ME21_third_layer.pdf",8000,100000,minimum_ME21_third_layer,maximum_ME21_third_layer);
obj.fitting_landau(obj.h_21[4], "ME21 4th layer", "ME21_fourth_layer.pdf",3000,50000,minimum_ME21_fourth_layer,maximum_ME21_fourth_layer);
obj.fitting_landau(obj.h_21[5], "ME21 5th layer", "ME21_fifth_layer.pdf",7000,50000,minimum_ME21_fifth_layer,maximum_ME21_fifth_layer);
...
obj.fitting_landau(obj.h_charge_CFEB_1_ME21, "ME21 CFEB1", "ME21_CFEB1.pdf",100000,500000,minimum_ME21_CFEB1,maximum_ME21_CFEB1);
