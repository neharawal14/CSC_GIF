...
class plotting{
  ...
  public:
    ...
    double trimmed_mean(TH1F *hist_fit, TString hist_to_fit);
    void drawing_hist();
    void plotting_mpv(double mpv_values[],int size, TString pdf_name);
//    TString saving_path_new = saving_path+run_number;
    TString saving_path = "/afs/cern.ch/user/n/nrawal/work/CSC_GIF/CMSSW_12_0_0_pre4/src/analyze_folder/MuonExercise0/analyze_output/program_final/plots/run_6249/";
  public: 
    TFile *my_file;
...
TString input_file = "/afs/cern.ch/user/n/nrawal/work/CSC_GIF/CMSSW_12_0_0_pre4/src/analyze_folder/MuonExercise0/test/outputFiles/output_6249.root";
...
// initialization for the constant value of the fit of the distribution
std::pair<double,double> constant_fit_ME11_total;
std::pair<double,double> constant_fit_ME21_total;
std::pair<double,double> constant_fit_ME11[7];
std::pair<double,double> constant_fit_ME21[7];
//std::pair<double,double> constant_fit_ME11_with_cuts[7];
std::pair<double,double> constant_fit_ME21_with_cuts[7];

std::pair<double,double> constant_fit_ME11_cuts_total;
std::pair<double,double> constant_fit_ME21_cuts_total;


double const_min_ME11[7],  const_min_ME21[7],  const_min_ME11_with_cuts[7],  const_min_ME21_with_cuts[7]; 
double const_max_ME11[7],  const_max_ME21[7],  const_max_ME11_with_cuts[7],  const_max_ME21_with_cuts[7]; 

double const_min_ME11_total , const_max_ME11_total;
double const_min_ME21_total , const_max_ME21_total;
double const_min_ME11_cuts_total , const_max_ME11_cuts_total;
double const_min_ME21_cuts_total , const_max_ME21_cuts_total;
for(int i=1; i<7; i++){
  constant_fit_ME11[i]  = obj.constant_value(obj.h_11[i]);
  constant_fit_ME21[i]  = obj.constant_value(obj.h_21[i]);
  constant_fit_ME21_with_cuts[i]  = obj.constant_value(obj.h_with_cuts_21[i]);
//  constant_fit_ME11_with_cuts[i]  = obj.constant(obj.h_with_cuts_11[i]);

  const_min_ME11[i] = constant_fit_ME11[i].first;
  const_max_ME11[i] = constant_fit_ME11[i].second;

  const_min_ME21[i] = constant_fit_ME21[i].first;
  const_max_ME21[i] = constant_fit_ME21[i].second;

//  const_min_ME11_with_cuts[i] = constant_fit_ME11_with_cuts[i].first;
//  const_max_ME11_with_cuts[i] = constant_fit_ME11_with_cuts[i].second;

  const_min_ME21_with_cuts[i] = constant_fit_ME21_with_cuts[i].first;
  const_max_ME21_with_cuts[i] = constant_fit_ME21_with_cuts[i].second;

 }
  constant_fit_ME11_total  = obj.constant_value(obj.h_charge_ME11);
  constant_fit_ME21_total  = obj.constant_value(obj.h_charge_ME21);
  constant_fit_ME11_cuts_total  = obj.constant_value(obj.h_charge_ME11_cuts);
  constant_fit_ME21_cuts_total  = obj.constant_value(obj.h_charge_ME21_cuts);

  const_min_ME21_total = constant_fit_ME21_total.first;
  const_max_ME21_total = constant_fit_ME21_total.second;
  const_min_ME11_total = constant_fit_ME11_total.first;
  const_max_ME11_total = constant_fit_ME11_total.second;

  const_min_ME21_cuts_total = constant_fit_ME21_cuts_total.first;
  const_max_ME21_cuts_total = constant_fit_ME21_cuts_total.second;
  const_min_ME11_cuts_total = constant_fit_ME11_cuts_total.first;
  const_max_ME11_cuts_total = constant_fit_ME11_cuts_total.second;
...
double mean_trim_ME21[6];


mpv_ME11 = obj.fitting_landau(obj.h_charge_ME11, "ME11 layer", "ME11.pdf","ME11","layers",const_min_ME11_total,const_max_ME11_total,minimum_ME11,maximum_ME11);
mpv_ME21 = obj.fitting_landau(obj.h_charge_ME21, "ME21 layer", "ME21.pdf","ME21","layers",const_min_ME21_total,const_max_ME21_total,minimum_ME21,maximum_ME21);
mpv_ME21_cuts= obj.fitting_landau(obj.h_charge_ME21_cuts, "ME21 layer after selection", "ME21_with_cuts.pdf","ME21_cuts","layers",const_min_ME21_cuts_total,const_max_ME21_cuts_total,minimum_ME21_cuts,maximum_ME21_cuts);
mpv_ME11_cuts= obj.fitting_landau(obj.h_charge_ME11_cuts, "ME11 layer after selection", "ME11_with_cuts.pdf","ME11_cuts","layers",const_min_ME11_cuts_total,const_max_ME11_cuts_total,minimum_ME11_cuts,maximum_ME11_cuts);

mpv_ME21_layers_with_cuts[0] = obj.fitting_landau(obj.h_with_cuts_21[1], "ME21 1st layer after selection", "ME21_with_cuts_first_layer.pdf","ME21_cuts","1st",const_min_ME21_with_cuts[1],const_max_ME21_with_cuts[1],minimum_ME21_with_cuts_first_layer,maximum_ME21_with_cuts_first_layer);
mpv_ME21_layers_with_cuts[1] = obj.fitting_landau(obj.h_with_cuts_21[2], "ME21 2nd layer after selection", "ME21_with_cuts_second_layer.pdf","ME21_cuts","2nd",const_min_ME21_with_cuts[2],const_max_ME21_with_cuts[2],minimum_ME21_with_cuts_second_layer,maximum_ME21_with_cuts_second_layer);
mpv_ME21_layers_with_cuts[2] = obj.fitting_landau(obj.h_with_cuts_21[3], "ME21 3rd layer after selection", "ME21_with_cuts_third_layer.pdf","ME21_cuts","3rd",const_min_ME21_with_cuts[3],const_max_ME21_with_cuts[3],minimum_ME21_with_cuts_third_layer,maximum_ME21_with_cuts_third_layer);
mpv_ME21_layers_with_cuts[3] = obj.fitting_landau(obj.h_with_cuts_21[4], "ME21 4th layer after selection", "ME21_with_cuts_fourth_layer.pdf","ME21_cuts","4th",const_min_ME21_with_cuts[4],const_max_ME21_with_cuts[4],minimum_ME21_with_cuts_fourth_layer,maximum_ME21_with_cuts_fourth_layer);
mpv_ME21_layers_with_cuts[4] = obj.fitting_landau(obj.h_with_cuts_21[5], "ME21 5th layer after selection", "ME21_with_cuts_fifth_layer.pdf","ME21_cuts","5th",const_min_ME21_with_cuts[5],const_max_ME21_with_cuts[5],minimum_ME21_with_cuts_fifth_layer,maximum_ME21_with_cuts_fifth_layer);
mpv_ME21_layers_with_cuts[5] = obj.fitting_landau(obj.h_with_cuts_21[6], "ME21 6th layer after selection", "ME21_with_cuts_sixth_layer.pdf","ME21_cuts","6th",const_min_ME21_with_cuts[6],const_max_ME21_with_cuts[6],minimum_ME21_with_cuts_sixth_layer,maximum_ME21_with_cuts_sixth_layer);

mpv_ME11_layers[0] = obj.fitting_landau(obj.h_11[1], "ME11 1st layer", "ME11_first_layer.pdf","ME11","1st",const_min_ME11[1],const_max_ME11[1],minimum_ME11_first_layer,maximum_ME11_first_layer);
mpv_ME11_layers[1] = obj.fitting_landau(obj.h_11[2], "ME11 2nd layer", "ME11_second_layer.pdf","ME11","2nd",const_min_ME11[2],const_max_ME11[2],minimum_ME11_second_layer,maximum_ME11_second_layer);
mpv_ME11_layers[2]= obj.fitting_landau(obj.h_11[3], "ME11 3rd layer", "ME11_third_layer.pdf","ME11","3rd",const_min_ME11[3],const_max_ME11[3],minimum_ME11_third_layer,maximum_ME11_third_layer);
mpv_ME11_layers[3] = obj.fitting_landau(obj.h_11[4], "ME11 4th layer", "ME11_fourth_layer.pdf","ME11","4th",const_min_ME11[4],const_max_ME11[4],minimum_ME11_fourth_layer,maximum_ME11_fourth_layer);
mpv_ME11_layers[4] = obj.fitting_landau(obj.h_11[5], "ME11 5th layer", "ME11_fifth_layer.pdf","ME11","5th",const_min_ME11[5],const_max_ME11[5],minimum_ME11_fifth_layer,maximum_ME11_fifth_layer);
mpv_ME11_layers[5] = obj.fitting_landau(obj.h_11[6], "ME11 6th layer", "ME11_sixth_layer.pdf","ME11","6th",const_min_ME11[6],const_max_ME11[6],minimum_ME11_sixth_layer,maximum_ME11_sixth_layer);


mpv_ME21_layers[0] = obj.fitting_landau(obj.h_21[1], "ME21 1st layer", "ME21_first_layer.pdf","ME21","1st",const_min_ME21[1],const_max_ME21[1],minimum_ME21_first_layer,maximum_ME21_first_layer);
mpv_ME21_layers[1] = obj.fitting_landau(obj.h_21[2], "ME21 2nd layer", "ME21_second_layer.pdf","ME21","2nd",const_min_ME21[2],const_max_ME21[2],minimum_ME21_second_layer,maximum_ME21_second_layer);
mpv_ME21_layers[2] = obj.fitting_landau(obj.h_21[3], "ME21 3rd layer", "ME21_third_layer.pdf","ME21","3rd",const_min_ME21[3],const_max_ME21[3],minimum_ME21_third_layer,maximum_ME21_third_layer);
mpv_ME21_layers[3] = obj.fitting_landau(obj.h_21[4], "ME21 4th layer", "ME21_fourth_layer.pdf","ME21","4th",const_min_ME21[4],const_max_ME21[4],minimum_ME21_fourth_layer,maximum_ME21_fourth_layer);
mpv_ME21_layers[4] = obj.fitting_landau(obj.h_21[5], "ME21 5th layer", "ME21_fifth_layer.pdf","ME21","5th",const_min_ME21[5],const_max_ME21[1],minimum_ME21_fifth_layer,maximum_ME21_fifth_layer);
mpv_ME21_layers[5] = obj.fitting_landau(obj.h_21[6], "ME21 6th layer", "ME21_sixth_layer.pdf","ME21","6th",const_min_ME21[6],const_max_ME21[6],minimum_ME21_sixth_layer,maximum_ME21_sixth_layer);
...
obj.plotting_mpv(mpv_ME11_layers_with_cuts,6,"ME11_with_cuts");


// To plot the canvas for trimmed mean
//
//
TString layer_name[6] = {"first","second","third","fourth","fifth","sixth"};
for(int i=1; i<=6;i++){
    
//TString saving_name_ME11_trimmed ="ME11_with_cuts_"+  layer[i] +"_layer_trimmed_.pdf");
TString saving_name_ME21_trimmed ="ME21_with_cuts_"+  layer_name[i-1] +"_layer_trimmed_.pdf";
  
//mean_trim_ME11[i] = obj.trimmed_mean(obj.h_with_cuts_11[i],saving_name_ME11_trimmed);
mean_trim_ME21[i-1] = obj.trimmed_mean(obj.h_with_cuts_21[i], saving_name_ME21_trimmed);
}

// opening a text file and saving the MPV and trimmed values for ME21 after the selection

      ofstream mpv_values;
      mpv_values.open("mpv_values_6249.txt");  
      mpv_values<<"MPV values from the landau fit for ME21 after selection"<<std::endl;
      
      for(int i =0; i<6;i++){
      mpv_values<<mpv_ME21_layers_with_cuts[i]<<std::endl;
      }

      mpv_values<<"trimeed mean value from the histogram for ME21 after selection"<<std::endl;
      
      for(int i =0; i<6;i++){
      mpv_values<<mean_trim_ME21[i]<<std::endl;
      }
