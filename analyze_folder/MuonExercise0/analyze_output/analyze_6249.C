...
class plotting{
  ...
  public:
    ...
    TString saving_path = "/afs/cern.ch/user/n/nrawal/work/CSC_GIF/CMSSW_12_0_0_pre4/src/analyze_folder/MuonExercise0/analyze_output/plots/run_6249/";
  public: 
    TFile *my_file;
...
mpv_ME11 = obj.fitting_landau(obj.h_charge_ME11, "ME11 layer", "ME11.pdf","ME11","layers",3000,90000,minimum_ME11,maximum_ME11);
...
mpv_ME21_layers_with_cuts[0] = obj.fitting_landau(obj.h_with_cuts_21[1], "ME21 1st layer after selection", "ME21_with_cuts_first_layer.pdf","ME21_cuts","1st",4000,6000,minimum_ME21_with_cuts_first_layer,maximum_ME21_with_cuts_first_layer);
mpv_ME21_layers_with_cuts[1] = obj.fitting_landau(obj.h_with_cuts_21[2], "ME21 2nd layer after selection", "ME21_with_cuts_second_layer.pdf","ME21_cuts","2nd",4000,6000,minimum_ME21_with_cuts_second_layer,maximum_ME21_with_cuts_second_layer);
mpv_ME21_layers_with_cuts[2] = obj.fitting_landau(obj.h_with_cuts_21[3], "ME21 3rd layer after selection", "ME21_with_cuts_third_layer.pdf","ME21_cuts","3rd",4000,6000,minimum_ME21_with_cuts_third_layer,maximum_ME21_with_cuts_third_layer);
mpv_ME21_layers_with_cuts[3] = obj.fitting_landau(obj.h_with_cuts_21[4], "ME21 4th layer after selection", "ME21_with_cuts_fourth_layer.pdf","ME21_cuts","4th",4000,6000,minimum_ME21_with_cuts_fourth_layer,maximum_ME21_with_cuts_fourth_layer);
mpv_ME21_layers_with_cuts[4] = obj.fitting_landau(obj.h_with_cuts_21[5], "ME21 5th layer after selection", "ME21_with_cuts_fifth_layer.pdf","ME21_cuts","5th",4000,6000,minimum_ME21_with_cuts_fifth_layer,maximum_ME21_with_cuts_fifth_layer);
mpv_ME21_layers_with_cuts[5] = obj.fitting_landau(obj.h_with_cuts_21[6], "ME21 6th layer after selection", "ME21_with_cuts_sixth_layer.pdf","ME21_cuts","6th",4000,6000,minimum_ME21_with_cuts_sixth_layer,maximum_ME21_with_cuts_sixth_layer);

mpv_ME11_layers[0] = obj.fitting_landau(obj.h_11[1], "ME11 1st layer", "ME11_first_layer.pdf","ME11","1st",5000,20000,minimum_ME11_first_layer,maximum_ME11_first_layer);
mpv_ME11_layers[1] = obj.fitting_landau(obj.h_11[2], "ME11 2nd layer", "ME11_second_layer.pdf","ME11","2nd",5000,20000,minimum_ME11_second_layer,maximum_ME11_second_layer);
mpv_ME11_layers[2]= obj.fitting_landau(obj.h_11[3], "ME11 3rd layer", "ME11_third_layer.pdf","ME11","3rd",5000,20000,minimum_ME11_third_layer,maximum_ME11_third_layer);
mpv_ME11_layers[3] = obj.fitting_landau(obj.h_11[4], "ME11 4th layer", "ME11_fourth_layer.pdf","ME11","4th",5000,20000,minimum_ME11_fourth_layer,maximum_ME11_fourth_layer);
mpv_ME11_layers[4] = obj.fitting_landau(obj.h_11[5], "ME11 5th layer", "ME11_fifth_layer.pdf","ME11","5th",5000,20000,minimum_ME11_fifth_layer,maximum_ME11_fifth_layer);
mpv_ME11_layers[5] = obj.fitting_landau(obj.h_11[6], "ME11 6th layer", "ME11_sixth_layer.pdf","ME11","6th",5000,20000,minimum_ME11_sixth_layer,maximum_ME11_sixth_layer);


mpv_ME21_layers[0] = obj.fitting_landau(obj.h_21[1], "ME21 1st layer", "ME21_first_layer.pdf","ME21","1st",5000,20000,minimum_ME21_first_layer,maximum_ME21_first_layer);
mpv_ME21_layers[1] = obj.fitting_landau(obj.h_21[2], "ME21 2nd layer", "ME21_second_layer.pdf","ME21","2nd",5000,20000,minimum_ME21_second_layer,maximum_ME21_second_layer);
mpv_ME21_layers[2] = obj.fitting_landau(obj.h_21[3], "ME21 3rd layer", "ME21_third_layer.pdf","ME21","3rd",5000,20000,minimum_ME21_third_layer,maximum_ME21_third_layer);
mpv_ME21_layers[3] = obj.fitting_landau(obj.h_21[4], "ME21 4th layer", "ME21_fourth_layer.pdf","ME21","4th",5000,20000,minimum_ME21_fourth_layer,maximum_ME21_fourth_layer);
mpv_ME21_layers[4] = obj.fitting_landau(obj.h_21[5], "ME21 5th layer", "ME21_fifth_layer.pdf","ME21","5th",5000,20000,minimum_ME21_fifth_layer,maximum_ME21_fifth_layer);
mpv_ME21_layers[5] = obj.fitting_landau(obj.h_21[6], "ME21 6th layer", "ME21_sixth_layer.pdf","ME21","6th",5000,20000,minimum_ME21_sixth_layer,maximum_ME21_sixth_layer);
