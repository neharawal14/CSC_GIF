...
obj.fitting_landau(obj.h_21[4], "ME21 4th layer", "ME21_fourth_layer.pdf",5000,50000,minimum_ME21_fourth_layer,maximum_ME21_fourth_layer);
obj.fitting_landau(obj.h_21[5], "ME21 5th layer", "ME21_fifth_layer.pdf",8000,80000,minimum_ME21_fifth_layer,maximum_ME21_fifth_layer);
...
obj.fitting_landau(obj.h_charge_CFEB_1_ME11, "ME11 CFEB1", "ME11_CFEB1.pdf",10000,100000,150,500);
