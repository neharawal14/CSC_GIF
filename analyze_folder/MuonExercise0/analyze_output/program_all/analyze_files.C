...
//    TString saving_path_new = saving_path+run_number;
    TString saving_path = "/afs/cern.ch/user/n/nrawal/work/CSC_GIF/CMSSW_12_0_0_pre4/src/analyze_folder/MuonExercise0/analyze_output/program_all/plots/run_7572_all/";
  public: 
    TFile *my_file;
...
//       h_xreco = (TH1F*) directory_name->Get("hist_xreco");
...
TString input_file = "/afs/cern.ch/user/n/nrawal/work/CSC_GIF/CMSSW_12_0_0_pre4/src/analyze_folder/MuonExercise0/test/outputFiles/output_7572_all.root";
...
TString title_name_ME11_with_cuts[6] = {"ME11 1st layer after selection", "ME11 2nd layer after selection", "ME11 3rd layer after selection","ME11 4th layer after selection", "ME11 5th layer after selection", "ME11 6th layer after selection"};
 ...
 TString title_name_trimmed_ME11_layers_with_cuts[6] = {"trim_mean_ME11_1stlayer.pdf","trim_mean_ME11_2ndlayer.pdf","trim_mean_ME11_3rdlayer.pdf","trim_mean_ME11_4thlayer.pdf","trim_mean_ME11_5thlayer.pdf","trim_mean_ME11_6thlayer.pdf"};
 TString title_name_trimmed_ME21_layers_with_cuts[6] = {"trim_mean_ME21_1stlayer.pdf","trim_mean_ME21_2ndlayer.pdf","trim_mean_ME21_3rdlayer.pdf","trim_mean_ME21_4thlayer.pdf","trim_mean_ME21_5thlayer.pdf","trim_mean_ME21_6thlayer.pdf"};


double trimmed_mean_ME21_layers_with_cuts[6], trimmed_mean_ME21[6], trimmed_mean_ME11[6], trimmed_mean_ME11_layers_with_cuts[6];
for(int i=0; i<6;i++){
...
ofstream fit_txt_mpv;// fit_txt_ME21_with_position_cuts;
//fit_txt_ME11.open("ME11_MPV.txt");
//fit_txt_ME21.open("ME21_MPV.txt");
//fit_txt_ME11_with_cuts.open("ME11_MPV_cuts.txt");
//fit_txt_ME21_with_cuts.open("ME21_MPV_cuts.txt");
//fit_txt_ME21_with_position_cuts.open("ME21_MPV_position_cuts.txt");
fit_txt_mpv.open("MPV.txt",std::ios_base::app);
...
fit_txt_mpv<<"mpv_ME11_layers_with_cuts trimmed fit"<<std::endl;
for(int i=0; i<6;i++){
/* fit_txt_ME11<<mpv_ME11<<std::endl;
 fit_txt_ME21<<mpv_ME21<<std::endl;
 fit_txt_ME11_with_cuts<<mpv_ME11<<std::endl;
 fit_txt_ME21_with_cuts<<mpv_ME11<<std::endl;
*/
  fit_txt_mpv<<trimmed_mean_ME11_layers_with_cuts[i]<<std::endl;
}
